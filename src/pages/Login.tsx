                ...
                <div>
                  <button className="inline-flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50">
                    ...
                    <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.545 12.151c0 1.054-.855 1.909-1.909 1.909s-1.909-.855-1.909-1.909.855-1.909 1.909-1.909 1.909.855 1.909 1.909z" />
                      <path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm2.847 14.753H9.175a3.856 3.856 0 1 1 5.672 0z" />
                    </svg>
                  </button>
                </div>
